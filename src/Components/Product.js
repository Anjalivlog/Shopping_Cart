...
const Product = () => {
    ...
    const setDecrease = () => {
      baseQty > 1 ? setBaseQty(baseQty - 1) : setBaseQty(1);
    };
          ...
          <div className='flex gap-4'>
            <div className='w-52 flex items-center justify-between text-gray-500 gap-4 border p-3'>
              ...
              <div className='flex items-center gap-4 text-sm font-semibold'>
                ...
                active:bg-black'>-</button>
                <span className='w-5 items-center justify-center'>{baseQty}</span>
            ...
            <button onClick={() => addToCart(baseQty,details) & toast.success(`${details.title} is added`)}
             className='bg-black text-white py-3 px-6 active:bg-gray-800'>add to cart
            </button>
          </div>
